                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-8">
                                <div class="hero__caption">
                                    ...
                                    <h1 data-animation="fadeInUp" data-delay=".6s">I’m Developer Qamar Abbas</h1>
                                    ...
                                    <div class="hero__btn">
                                        ...
                                        {{-- <a href="industries.html" class="btn border-btn ml-15" data-animation="fadeInRight"
                                            data-delay="1.0s">Hire Me</a> --}}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-8">
                                <div class="hero__caption">
                                    <span data-animation="fadeInUp" data-delay=".4s">Get Every Single Solutions.</span>
                                    <h1 data-animation="fadeInUp" data-delay=".6s">I’m Designer Qamar Abbas</h1>
                                    <P data-animation="fadeInUp" data-delay=".8s">jhorem rfpsum golor sidt amet,
                                        consectetur adipiscing elit, eiusmod tempor incididunt utcjhg labore bet dolore
                                        magna aliqua. Quis ipsum suspendisse ultrices gravida.</P>
                                    <!-- Hero-btn -->
                ...
                <div class="row ">
                    <div class="col-lg-5">
                        <div class="about-caption mb-50">
                            ...
                            <p class="pera1">Consectetur adipiscing elit, sed do eiusmod tempor ididunt ut labore et
                                dolore magna aliqua. Quis ipsum suspendisces gravida. Risus commodo viverra sebfd dho
                                eiusmod tempor maecenas accumsan lacus.</p>
                    ...
                    <div class="col-lg-5 offset-lg-1">
                        <div class="about-caption2">
                            ...
                            <div class="send-cv">
                                <a href="mailto:syed.abbas96045@gmail.com">syed.abbas96045@gmail.com</a>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat text-center mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a href="services.html">Frontend Development</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat text-center mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a href="services.html">Backend Development</a></h5>
                                <p>Free resource that will help nderstand thecv designc process and improve theroi
                                    nderstand the design process andisei impro are of vquality.</p>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat text-center mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a href="services.html">Website Development</a></h5>
                                <p>Free resource that will help nderstand thecv designc process and improve theroi
                                    nderstand the design process andisei impro are of vquality.</p>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 col-md-8 col-sm-8">
                                            ...
                                            <div class="single-services mb-30">
                                                <img src="{{ asset('assets/img/service/services1.png') }}" alt="">
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <!-- Single -->
                                                    <div class="single-services mb-30">
                                                        <img src="{{ asset('assets/img/service/services2.png') }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                    <!-- Single -->
                                                    <div class="single-services mb-30">
                                                        <img src="{{ asset('assets/img/service/services3.png') }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <!-- Single -->
                                            <div class="single-services mb-30">
                                                <img src="{{ asset('assets/img/service/services4.png') }}" alt="">
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <!-- Single -->
                                            <div class="single-services mb-30">
                                                <img src="{{ asset('assets/img/service/services5.png') }}" alt="">
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <!-- Single -->
                                            <div class="single-services mb-30">
                                                <img src="{{ asset('assets/img/service/services6.png') }}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="services-caption">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <!-- Single -->
                                            <div class="single-services mb-30">
                                                <img src="{{ asset('assets/img/service/services5.png') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <!-- Single -->
                                            <div class="single-services mb-30">
                                                <img src="{{ asset('assets/img/service/services1.png') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="services-caption">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <!-- Single -->
                                            <div class="single-services mb-30">
                                                <img src="{{ asset('assets/img/service/services4.png') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <!-- Single -->
                                            <div class="single-services mb-30">
                                                <img src="{{ asset('assets/img/service/services6.png') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
